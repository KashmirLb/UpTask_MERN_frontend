...
const ModalEliminarColaborador = () => {
    ...
    const { modalEliminarColaborador, handleModalEliminarColaborador, alerta, colaborador, eliminarColaborador } = useProyecto()
                    ...
                    >
                            ...
                            <div className="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-red-100 sm:mx-0 sm:h-10 sm:w-10">
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    <p>Deseas eliminar este colaborador?</p>
                                    <p>Una vez eliminado no podrá acceder al proyecto.</p>
                            ...
                            <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                                <button
                                    ...
                                    text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:ml-3 
                                ...
                                <button
                                    ...
                                    className="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium
                                     text-gray-700 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:w-auto sm:text-sm"
                                    onClick={handleModalEliminarColaborador}
                                > Cancelar</button>
                            </div>
